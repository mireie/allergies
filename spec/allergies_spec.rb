...
describe("#allergies") do
  ...
  it("returns all allergies with a score of 255") do
    score = Allergies.new(255)
    expect(score.find_allergies).to(eq(["cats", "pollen", "chocolate", "tomatoes", "strawberries", "shellfish", "peanuts", "eggs"]))
  end
end
